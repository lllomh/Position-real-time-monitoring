        ...
        <table class="content">
            <tr style="height: 15%">
                <td>
                    <div class="head-top">
                        <div class="logo">
                         <button class="btns tc" @click="toadd()"><span><i>我</i><i>要</i><i>增加</i><i>城市</i></span></button>
                          <div class="textsub" :class="{rotation:isac}">
                              <a href="https://jq.qq.com/?_wv=1027&k=X8EDebNq" target="_blank" @keyup.enter="addToList">点我加群反馈</a>
                          </div>
                        </div>
